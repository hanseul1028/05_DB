...
-- 가입일 -> SYSDATE를 활용
INSERT INTO "MEMBER"
VALUES('MEM02','POI098','김미영','981212-9876453',SYSDATE);

-- 가입일 -> DEFAULT 활용(테이블 생성 시 정의된 값이 반영됨)
INSERT INTO "MEMBER"
VALUES('MEM03','POI668','김철수','985552-2345678',DEFAULT);
...
VALUES('MEM04','JKH876','김철수','97302-2345668');
...
DROP TABLE USER_USED_UK; -- 테이블 삭제 구문
...
CREATE TABLE USER_USED_FK3(
  ...
  ON DELETE CASCADE -- 부모 행 삭제 시 참조하는 모든 자식 행 삭제
);
...
INSERT INTO CHECK_TEST VALUES ('철수', 300); -- 체크 제약조건이 위배
INSERT INTO CHECK_TEST VALUES ('훈이', 0);   -- 체크 제약조건이 위배
...
CREATE TABLE USER_TEST(
	...
	USER_PNO CHAR(14) CONSTRAINT NN_PNO NOT NULL,
	GENDER CHAR(3),
	PHONE CHAR(13),
...
VALUES ('NO1', 'QWE123','ERT3445', '980120-4561222', '남','01078965454','주소','Y');
VALUES ('NO2', 'FGD454','GG0000', '981024-4561222', '남','01078965454','주소','Y');
VALUES ('NO3', 'HGGH6445','FGG2', '980212-4561222', '남','01078965454','주소','Y');
VALUES ('NO4', 'QS5463','K253', '988888-4561222', '남','01078965454','주소','Y');
VALUES ('NO5', 'JH89','SGFT44', '988888-4561222', '남','01078965454','주소','Y');
 ...
 * 
 * NOT NULL은 컬럼의 상태(NULL 허용, NULL 불가)를
 * 수정(MODIFY)하는 모습
 * */
