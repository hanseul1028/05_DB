...
INSERT INTO V_DCOPY2
VALUES('A1', '마케팅1팀');
-- NULL을 ("KH09_KHS"."DEPT_COPY2"."LOCATION_ID")
-- 안에 삽입할 수 없습니다

-- V_DCOPY2를 이용하면 LOCATION_ID 컬럼에 
-- INSERT할 수 없기 때문데 자동으로 NULL이 삽입됨
...
/* 인덱스를 활용해서 검색하는 방법
 * - SELECT 문의 WHERE절에 INDEX가 설정된 컬럼을 언급하면 된다
 * */
